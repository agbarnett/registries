...
```{r, fig.width=8}
exclude_large = filter(studies, samplesize_target < 2000) # exclude large studies
...
```{r, fig.width=8}
# exclude some studies for this plot
exclude_large = filter(studies, samplesize_target <= 200) # 
# frequency
...
if(is_results == FALSE){
  source('3_elasticnet_model_samplesize_clintrial.R')
}
# get the labels
...
to_plot
# save for paper
save(to_plot, file='figures/fig5.RData')
